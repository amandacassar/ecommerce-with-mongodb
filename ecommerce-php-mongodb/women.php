...
<script>
  ...
  function loadProducts()
  {
      ...
      sessionStorage.setItem("lastSearch", "women");
      ...
      request.open("GET", "get_women_products.php");
  ...
  function displayProducts(jsonProducts)
  {
      ...
      document.getElementById("womenProducts").innerHTML = htmlStr;
  }
  ...
  function filterItems(criteria)
  {
    ...
    if (criteria == "tops")
    {
      request.open("GET", "filter_women_products.php?filtering=tops");
      ...
      // clearing any previous keyword searches stored in the sessionStorage, and adding the latest search performed
      sessionStorage.removeItem("lastSearch");
      sessionStorage.setItem("lastSearch", "women tops");
    }

    else if (criteria == "bottoms")
    {
      request.open("GET", "filter_women_products.php?filtering=bottoms");
      ...
      // clearing any previous keyword searches stored in the sessionStorage, and adding the latest search performed
      sessionStorage.removeItem("lastSearch");
      sessionStorage.setItem("lastSearch", "women bottoms");
    }

    else if (criteria == "jackets")
    {
      request.open("GET", "filter_women_products.php?filtering=jackets");
      ...
      // clearing any previous keyword searches stored in the sessionStorage, and adding the latest search performed
      sessionStorage.removeItem("lastSearch");
      sessionStorage.setItem("lastSearch", "women jackets");
    }

    else if (criteria == "black")
    {
      request.open("GET", "filter_women_products.php?filtering=black");
      ...
      // clearing any previous keyword searches stored in the sessionStorage, and adding the latest search performed
      sessionStorage.removeItem("lastSearch");
      sessionStorage.setItem("lastSearch", "women black");
    }

    else if (criteria == "blue")
    {
      request.open("GET", "filter_women_products.php?filtering=blue");
      ...
      // clearing any previous keyword searches stored in the sessionStorage, and adding the latest search performed
      sessionStorage.removeItem("lastSearch");
      sessionStorage.setItem("lastSearch", "women blue");
    }

    else if (criteria == "green")
    {
      request.open("GET", "filter_women_products.php?filtering=green");
      ...
      // clearing any previous keyword searches stored in the sessionStorage, and adding the latest search performed
      sessionStorage.removeItem("lastSearch");
      sessionStorage.setItem("lastSearch", "women green");
    }

    else if (criteria == "small")
    {
      request.open("GET", "filter_women_products.php?filtering=S");
    ...
    {
      request.open("GET", "filter_women_products.php?filtering=M");
    ...
    {
      request.open("GET", "filter_women_products.php?filtering=L");
  ...
  function sortItems(sorting)
  {
    ...
    // set up request and send it
    request.open("GET", "sort_women_products.php?criteria=" + allCriteria);
